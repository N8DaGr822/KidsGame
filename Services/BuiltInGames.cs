...
public static class BuiltInGames
{
    ...
    public const string FunnyFaces = "funny-faces";
    ...
    public static readonly IReadOnlyList<BuiltInGame> All = new List<BuiltInGame>
    {
        ...
        new BuiltInGame("UNO", "🃏", Uno, "images/game-thumbs/uno.svg", MinAge: 6, MaxAge: 12),
        new BuiltInGame("Simon Says", "🔴", SimonSays, "images/game-thumbs/simon-says.svg", MinAge: 4, MaxAge: 9),
        new BuiltInGame("Sliding Puzzle", "🧩", SlidingPuzzle, "images/game-thumbs/sliding-puzzle.svg", MinAge: 5, MaxAge: 10),
        new BuiltInGame("Word Scramble", "🔤", WordScramble, "images/game-thumbs/word-scramble.svg", MinAge: 5, MaxAge: 10),
        new BuiltInGame("Minesweeper", "💣", Minesweeper, "images/game-thumbs/minesweeper.svg", MinAge: 6, MaxAge: 12),
        new BuiltInGame("Sudoku", "🔢", Sudoku, "images/game-thumbs/sudoku.svg", MinAge: 7, MaxAge: 13),
        ...
        new BuiltInGame("Funny Faces", "🤪", FunnyFaces, MinAge: 1, MaxAge: 3),
